...
<body>
    ...
    <div class = "div1">
        ...
        <div class="welcome">
        <p> <span style = "font-weight: bold;"><?php echo "Welcome, " . $_SESSION['username']  ?> </span>. The SmartFarm team is more than happy to welcome you to our family and we hope you wil have an amazing experience with us. Ensure you provide excellent customer service to our users and maintain user privacy as you manage data.</p>
        </div>
    </div>
