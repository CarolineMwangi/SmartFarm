...
$query = "SELECT * FROM products_table  WHERE product_category='eggs'";
...
if (isset($_POST['add_to_cart'])&&isset($_POST['product_id'])) {
   ...
   if (isset($_SESSION['shopping_cart'])) {
       ...
       if (!in_array($_POST['product_id'], $item_aray_id)) {
        ...
        echo '<script>window.location="category_eggs.php"</script>';
                ...
                foreach ($_SESSION['shopping_cart'] as $keys => $values) {
                   ...
                   <tr>
                        <td><?php echo '<div style="margin:5px;padding-right:10px"><img src="assets/'.$values["product_image"].'" width="120px" height="100px"><br>';?></td>
                            ...
                            <td><a href="category_eggs.php?action=delete&product_id=<?php echo $values['product_id']; ?>"><span class="text-danger">Remove</span></a></td>
                   </tr>
                   <?php
